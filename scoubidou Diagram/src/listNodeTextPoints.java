...
public class listNodeTextPoints {
	...
	public static nodePoint[] listOfNodePoints(){
		...
		int a=MyPrintCanvasTextDiagram.a;
		int b=MyPrintCanvasTextDiagram.b;
		int x1=MyPrintCanvasTextDiagram.x1;
		int y1=MyPrintCanvasTextDiagram.y1;
		int length=MyPrintCanvasTextDiagram.length;
