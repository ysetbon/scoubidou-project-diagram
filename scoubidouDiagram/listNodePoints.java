...
import scoubidouDiagram.MyPrintCanvasDiagram;
...
/*	*//** 
	...
	public static nodeLine[] fractedLine(nodeLine l , nodeLine[] contraLines){
		...
		System.out.println("count0minus-"+count0minus+"count0plus-"+count0plus+"coutlastminus-"+countlastminus+"countlastplus-"+countlastplus);
