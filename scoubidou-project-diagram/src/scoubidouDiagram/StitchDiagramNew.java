...
public class StitchDiagramNew extends Frame {
	...
	//	int x1OnLine=x1+MyPrintCanvasDiagram.length / 2;
		//int y1onLine =y1;
		StitchDiagramNew s = new StitchDiagramNew(
				MyPrintCanvasDiagram.length / 2, 0, x2,y2, "upToDown", x1,
				y1, Color.GREEN);
	...
	public StitchDiagramNew(int firstPointx, int firstPointy,
	 ...
	 * @return
	 */
	public Shape paintString(int firstPointx, int firstPointy,
